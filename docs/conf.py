...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.intersphinx', 'sphinx.ext.coverage', 'sphinx.ext.mathjax']
...
html_sidebars = {
    'index': ['sidebar-header.html', 'localtoc.html', 'sidebar-footer.html', 'searchbox.html'],
